...
class Perfil(models.Model):
    ...
    dt_nascimento = models.IntegerField(verbose_name="Data de Nascimento", auto_now_add=TRUE)
    telefone_fixo = models.ChardField(verbose_name="Telefone Fixo", max_length=10)

    def __str__(self):
        return f'Perfil de {self.usuario.username}'

    class Generp(models.Model):
